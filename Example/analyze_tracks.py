...
N_to_analyze = 1000    # total number of events to analyze
...
for evt_num in evt_nums:
  test_evt = 'event00000' + str(evt_num)

  print "Processing", test_evt
  hits, cells, particles, truth = load_event(os.path.join('skimmed_events',test_evt))
